...
const rawSingles: RawSingle[] = [
  ...
  { id: "zhi", symbol: "zhi", type: "whole", name: "整体认读音节 zhi", keyword: "织毛衣", rhyme: "整体认读 zhi zhi zhi" },
  { id: "chi", symbol: "chi", type: "whole", name: "整体认读音节 chi", keyword: "吃苹果", rhyme: "整体认读 chi chi chi" },
  { id: "shi", symbol: "shi", type: "whole", name: "整体认读音节 shi", keyword: "狮子", rhyme: "整体认读 shi shi shi" },
  { id: "ri", symbol: "ri", type: "whole", name: "整体认读音节 ri", keyword: "日出", rhyme: "整体认读 ri ri ri" },
  { id: "zi", symbol: "zi", type: "whole", name: "整体认读音节 zi", keyword: "写字", rhyme: "整体认读 zi zi zi" },
  { id: "ci", symbol: "ci", type: "whole", name: "整体认读音节 ci", keyword: "刺猬", rhyme: "整体认读 ci ci ci" },
  { id: "si", symbol: "si", type: "whole", name: "整体认读音节 si", keyword: "蚕丝", rhyme: "整体认读 si si si" },
  { id: "yi", symbol: "yi", type: "whole", name: "整体认读音节 yi", keyword: "衣服", rhyme: "整体认读 yi yi yi" },
  { id: "wu", symbol: "wu", type: "whole", name: "整体认读音节 wu", keyword: "乌鸦", rhyme: "整体认读 wu wu wu" },
  { id: "yu", symbol: "yu", type: "whole", name: "整体认读音节 yu", keyword: "小鱼", rhyme: "整体认读 yu yu yu" },
  { id: "ye", symbol: "ye", type: "whole", name: "整体认读音节 ye", keyword: "叶子", rhyme: "整体认读 ye ye ye" },
  { id: "yue", symbol: "yue", type: "whole", name: "整体认读音节 yue", keyword: "月亮", rhyme: "整体认读 yue yue yue" },
  { id: "yuan", symbol: "yuan", type: "whole", name: "整体认读音节 yuan", keyword: "圆圈", rhyme: "整体认读 yuan yuan yuan" },
  { id: "yin", symbol: "yin", type: "whole", name: "整体认读音节 yin", keyword: "音乐", rhyme: "整体认读 yin yin yin" },
  { id: "yun", symbol: "yun", type: "whole", name: "整体认读音节 yun", keyword: "白云", rhyme: "整体认读 yun yun yun" },
  { id: "ying", symbol: "ying", type: "whole", name: "整体认读音节 ying", keyword: "老鹰", rhyme: "整体认读 ying ying ying" },
];
